        ...
        <div className="relative z-10 flex flex-col justify-center px-16 xl:px-24 2xl:px-32">
          <div className="max-w-lg">
            ...
            <p className="text-lg text-slate-400 leading-relaxed">
              A QA sandbox built for <span className="text-slate-300 font-medium">UI testing</span>, <span className="text-slate-300 font-medium">API validation</span>, and <span className="text-slate-300 font-medium">load testing</span>. Isolated. Safe. No real funds.
            </p>
