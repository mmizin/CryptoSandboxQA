        ...
        <div className="relative z-10 flex flex-col justify-center px-16 xl:px-24 2xl:px-32">
          <div className="max-w-lg">
            <h1 className="text-4xl xl:text-5xl font-semibold text-white tracking-tight leading-tight mb-6">
              Trade crypto with
              <span className="bg-gradient-to-r from-emerald-400 to-cyan-400 bg-clip-text text-transparent"> confidence</span>
            </h1>
            <p className="text-lg text-slate-400 leading-relaxed">
              A professional-grade sandbox for practicing trades, validating transactions, and building automation skills — all in a safe environment.
            </p>
