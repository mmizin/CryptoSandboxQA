...
| Code style, naming, request-body locals | [`docs/engineering/CODE_STYLE_READABILITY.md`](../../../docs/engineering/CODE_STYLE_READABILITY.md) · [`docs/engineering/code-style-templates.md`](../../../docs/engineering/code-style-templates.md) · [`.cursor/rules/code-readability.mdc`](../../../.cursor/rules/code-readability.mdc) |
