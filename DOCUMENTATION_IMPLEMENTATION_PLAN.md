...
| 7 | Admin Role & Guards | 1 | High | S | ~0.5d | Login | PRD | ADR (role model) | Depends: PRD-Login · Produces: PRD-007, ADR-003 | Not Started |
...
| 9 | User Profile & Settings | 2 | Medium | S | ~0.5d | Registration, Login | PRD | — | Depends: PRD-Registration, PRD-Login · Produces: PRD-009 | Not Started |
| 10 | User Profile Extended (Register w/ Profile) | 2 | Low | S | ~0.5d | Registration | PRD | — | Depends: PRD-Registration · Produces: PRD-010 | Not Started |
...
| 12 | Impersonation (Admin → User) | 2 | High | M | ~1.5d | Admin Role, Session Mgmt | PRD | ADR (token/back-to-admin flow), C4 | Depends: PRD-007, PRD-SessionManagement · Produces: PRD-012, ADR-005 | Not Started |
