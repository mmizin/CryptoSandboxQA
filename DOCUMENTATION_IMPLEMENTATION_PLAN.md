...
| 8 | Admin User Creation (API Key Bootstrap) | 1 | Medium | S | ~0.5d | Admin Role & Guards | PRD | ADR (API-key bootstrap vs UI) | Depends: PRD-AdminRoleGuards · Produces: PRD-008, ADR-004 | Not Started |
