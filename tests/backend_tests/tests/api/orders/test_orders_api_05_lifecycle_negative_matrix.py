...
class TestOrdersLifecycleNegative:
    def test_cancel_unknown_order_returns_400(self, fxt_regular_user) -> None:
    ...
    def test_cancel_filled_order_rejected(self, fxt_regular_user) -> None:
    ...
    def test_set_status_unknown_order_returns_400(self, fxt_regular_user) -> None:
    ...
    def test_set_status_invalid_enum_returns_400(self, fxt_regular_user) -> None:
