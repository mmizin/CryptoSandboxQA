...
class TestOrdersValidationMatrix:
    def test_post_orders_without_bearer_returns_401(self) -> None:
    ...
    def test_insufficient_balance_buy_market(self, fxt_regular_user) -> None:
        ...
        assert response.status_code == 400, (
            f"expected HTTP 400; {response_assert_detail(response)}"
        )
        assert_response_contains(
            response, "Insufficient balance")

    def test_insufficient_balance_sell_market(self, fxt_regular_user) -> None:
    ...
    def test_invalid_trading_pair_not_in_seed(self, fxt_regular_user) -> None:
    ...
    def test_side_must_be_buy_or_sell(self, fxt_regular_user) -> None:
    ...
    def test_type_must_be_limit_or_market(self, fxt_regular_user) -> None:
    ...
    def test_quantity_must_be_positive(self, fxt_regular_user) -> None:
    ...
    def test_limit_requires_positive_price(self, fxt_regular_user) -> None:
    ...
    def test_limit_price_must_be_positive(self, fxt_regular_user) -> None:
    ...
    def test_symbol_base_quote_format(self, fxt_regular_user) -> None:
    ...
    def test_market_type_enumeration(self, fxt_regular_user) -> None:
    ...
    def test_initial_status_enumeration(self, fxt_regular_user) -> None:
    ...
    def test_get_orders_without_bearer_returns_401(self) -> None:
        with _client_no_auth() as c:
    ...
    def test_get_order_by_id_without_bearer_returns_401(self) -> None:
        with _client_no_auth() as c:
