...
class TestOrdersAdminOrders:
    def test_admin_list_orders_returns_200(self, fxt_admin_user, fxt_regular_user) -> None:
    ...
    def test_admin_get_order_returns_200(self, fxt_admin_user, fxt_regular_user) -> None:
    ...
    def test_admin_list_unknown_user_returns_404(self, fxt_admin_user) -> None:
    ...
    def test_admin_get_unknown_order_returns_404(self, fxt_admin_user, fxt_regular_user) -> None:
    ...
    def test_regular_user_cannot_list_admin_orders_forbidden(self, fxt_regular_user) -> None:
    ...
    def test_regular_user_cannot_get_admin_order_forbidden(self, fxt_regular_user) -> None:
